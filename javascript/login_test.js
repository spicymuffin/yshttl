...
//RSAKey.prototype.encrypt_b64 = RSAEncryptB64;z
...
//var myModule = require('require-from-url/sync');
// myModule("https://infra.yonsei.ac.kr/sso/js/rsa/jsbn.js");

var jsonObj = { 'userid': "**replaced ALIAS using filter-repo**", 'userpw': "password", 'ssoChallenge': ssoChallenge };
console.log(jsonObj)
...
console.log(rsa.encrypt(jsonStr))